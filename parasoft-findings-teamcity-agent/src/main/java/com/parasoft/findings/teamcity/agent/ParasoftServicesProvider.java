 ...
 */
public final class ParasoftServicesProvider
    extends DefaultServicesProvider
{
    private static ParasoftServicesProvider INSTANCE;

    private ParasoftServicesProvider() { }
    ...
    {
        if (INSTANCE == null) {
            INSTANCE = new ParasoftServicesProvider();
