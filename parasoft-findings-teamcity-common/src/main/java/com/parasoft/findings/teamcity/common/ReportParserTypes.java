...
public class ReportParserTypes {
    private static final String SOATEST_PARSER = "Parasoft SOAtest 9.x Report Parser"; //$NON-NLS-1$
    private static final String ANALYZERS_PARSER = "Parasoft Analyzers 10.x Report Parser"; //$NON-NLS-1$
    ...
    private static final ReportParserDescriptor[] _parsers = new ReportParserDescriptor[] { 
        new ReportParserDescriptor(ReportParserType.SOATEST_9, SOATEST_PARSER, SOATEST_XSL),
        new ReportParserDescriptor(ReportParserType.ANALYZERS_10, ANALYZERS_PARSER, ANALYZERS_XSL)
    };
